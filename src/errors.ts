 ...
 * ```ts
 * import { SerperError } from "@yigitkonur/sdk-deno-serper";
 *
 * try {
 ...
 * @example
 * ```ts
 * import { SerperAuthError } from "@yigitkonur/sdk-deno-serper";
 *
 * try {
 *   await client.search("query");
 * } catch (error) {
 ...
 * @example
 * ```ts
 * import { SerperRateLimitError } from "@yigitkonur/sdk-deno-serper";
 *
 * try {
 *   await client.search("query");
 * } catch (error) {
 ...
 * @example
 * ```ts
 * import { SerperValidationError } from "@yigitkonur/sdk-deno-serper";
 *
 * try {
 ...
 * @example
 * ```ts
 * import { SerperServerError } from "@yigitkonur/sdk-deno-serper";
 *
 * try {
 *   await client.search("query");
 * } catch (error) {
